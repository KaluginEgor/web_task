            ...
            <c:if test="${user.id != 0 and user.state == active}">
                <form action="controller" method="POST" class="movieRatingForm">
                    <fieldset class="rating">
                        <input type="radio" id="star10" name="movieRatingValue" value="10" onclick="submit()"/>
                        <label class="full" for="star10"
                               title="Awesome - 10 stars">10</label>

                        <input type="radio" id="star9" name="movieRatingValue" value="9" onclick="submit()"/>
                        <label class="full" for="star9"
                               title="Really good - 9 stars">9</label>

                        <input type="radio" id="star8" name="movieRatingValue" value="8" onclick="submit()"/>
                        <label class="full" for="star8"
                               title="Pretty good - 8 stars">8</label>

                        <input type="radio" id="star7" name="movieRatingValue" value="7" onclick="submit()"/>
                        <label class="full" for="star7"
                               title="I'd watch it again with a beer - 7 stars">7</label>

                        <input type="radio" id="star6" name="movieRatingValue" value="6" onclick="submit()"/>
                        <label class="full" for="star6"
                               title="Not so bad - 6 stars">6</label>

                        <input type="radio" id="star5" name="movieRatingValue" value="5" onclick="submit()"/>
                        <label class="full" for="star5"
                               title="Kinda bad - 5 stars">5</label>

                        <input type="radio" id="star4" name="movieRatingValue" value="4" onclick="submit()"/>
                        <label class="full" for="star4"
                               title="Bad - 4 stars">4</label>

                        <input type="radio" id="star3" name="movieRatingValue" value="3" onclick="submit()"/>
                        <label class="full" for="star3"
                               title="Really bad - 3 stars">3</label>

                        <input type="radio" id="star2" name="movieRatingValue" value="2" onclick="submit()"/>
                        <label class="full" for="star2"
                               title="Lame - 2 stars">2</label>

                        <input type="radio" id="star1" name="movieRatingValue" value="1" onclick="submit()"/>
