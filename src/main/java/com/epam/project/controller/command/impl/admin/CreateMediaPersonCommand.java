...
/**
 * The type Create media person command.
 */
    ...
    public CommandResult execute(SessionRequestContent sessionRequestContent) throws CommandException {
        ...
        if (firstName == null || secondName == null || bio == null || stringBirthday == null) {
            ...
            if (!errorMessages.isEmpty()) {
                ...
                try {
                    findResult = mediaPersonService.create(firstName, secondName, bio, stringOccupationTypeId, stringBirthday, picture, stringMoviesId);
